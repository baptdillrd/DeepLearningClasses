...
plt.figure(figsize=(10, 5))
plt.plot(df['epoch'], df['train_loss'], label="Train Loss", color='tab:red', marker='o', markersize=4)
plt.plot(df['epoch'], df['test_loss'], label="Test Loss", color='tab:blue', marker='o', markersize=4)
