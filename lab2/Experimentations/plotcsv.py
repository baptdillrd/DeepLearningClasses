...
plt.figure(figsize=(10, 5))
plt.plot(df['epoch'], df['train_loss'], color='tab:red', label="Train Loss", marker='o', markersize=4)
plt.plot(df['epoch'], df['test_loss'], color='tab:blue', label="Test Loss", marker='o', markersize=4)
